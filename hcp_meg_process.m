...
for iSubj = 1:length(SubjectNames)
    ...
    % Process: Scouts time series: [201 scouts]
    sScoutTS = bst_process('CallProcess', 'process_extract_scout', sSrcRest, [], ...
    ...
    % ===== BAND-PASS FILTERING: FREQ BANDS =====
    % Frequency bands
    ...
    for iBand = 1:numel(sBandLabels)
        ...
        if ~isfolder(outpath)
            ...
            copyfile(tsMatrix, fullfile(outpath, strcat(SubjectNames{iSubj}, ...
                '_timeseries_', sBandLabels{iBand}, '.mat')))
        end   
    end
